...
type FormDialogProps = {
  parentRow: App.Data.PurchaseData
  currentRow?: App.Data.PurchaseReturnData
}
export function FormDialog({ parentRow, currentRow }: FormDialogProps) {
  ...
  const isLoadingSuppliers = false
  const suppliers = [parentRow.supplier]
  ...
  const initValues = () => {
    ...
    form.setValue(
      'supplier_id',
      parentRow.supplier?.id || (null as unknown as number)
    )
  ...
  useUpdateEffect(() => {
    function loadValues() {
      ...
      form.setValue('status', (currentRow?.status as unknown as number) || 1)
      ...
      form.setValue(
        'supplier_id',
        currentRow?.supplier_id || (null as unknown as number)
      )
  ...
  const generate = () => {
    form.setValue(
      'reference',
      'PR-' + faker.string.alphanumeric({ length: 8, casing: 'upper' }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='h-fit items-start sm:col-span-3 lg:col-span-4'>
                  <FormLabel>Purchase Return Date</FormLabel>
                  <DatePicker
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className='text-end'>Pur. Qty</TableHead>
                    <TableHead className='text-end'>Ret. Qty</TableHead>
                    <TableHead className='text-end'>Pur. Disc.</TableHead>
